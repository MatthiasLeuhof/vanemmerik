...
var Grid = (function() {
  ...
  // Currently expanded item's index
  current = -1,
  ...
  Preview.prototype = {
    ...
    create : function() {
      ...
      this.$fullvideo = $( '<div class="og-fullvideo"></div>' ).append( this.$loading );
      this.$closePreview = $( '<span class="og-close"></span>' );
      this.$previewInner = $( '<div class="og-expander-inner"></div>' ).append( this.$closePreview, this.$fullvideo, this.$details );
    ...
    update : function( $item ) {
      ...
      if( self.$fullvideo.is( ':visible' ) ) {
        ...
        $( '</iframe>' ).load( function() {
          ...
          self.$fullvideo.append( self.$largeImg );
